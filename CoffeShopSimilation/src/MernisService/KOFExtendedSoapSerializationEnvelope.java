...
public class KOFExtendedSoapSerializationEnvelope extends com.easywsdl.exksoap2.serialization.ExSoapSerializationEnvelope {
    ...
    public static void setDateTimeConverter(KOFDateTimeConverter converter)
    {
        if(converter==null)
        {
            dateTimeConverter = new KOFStandardDateTimeConverter();
        }
        dateTimeConverter=converter;
    }

    public static KOFDateTimeConverter getDateTimeConverter()
    {
        return dateTimeConverter;
    }

    private static KOFDateTimeConverter dateTimeConverter = new KOFStandardDateTimeConverter();

    public KOFExtendedSoapSerializationEnvelope() {
        this(SoapEnvelope.VER11);
    }

    public KOFExtendedSoapSerializationEnvelope(int soapVersion) {
        super(soapVersion);
        implicitTypes = true;
        setAddAdornments(false);
        new KOFMarshalGuid().register(this);
    ...
    protected void writeProperty(XmlSerializer writer, java.lang.Object obj, PropertyInfo type) throws IOException {
        ...
        if (!type.multiRef && qName[2] == null )
        {
            if (!implicitTypes || (obj.getClass() != type.type && !(obj instanceof Vector ) && type.type!=java.lang.String.class  )) {
                java.lang.String xmlName=KOFHelper.getKeyByValue(classNames,obj.getClass());
                if(xmlName!=null) {
    ...
    private Object createObject(Object soap, Class cl) throws InstantiationException, IllegalAccessException, NoSuchMethodException, InvocationTargetException {
        ...
        Method ctor = obj.getClass().getMethod("loadFromSoap",Object.class,KOFExtendedSoapSerializationEnvelope.class);
    ...
    public static java.lang.Object getXSDType(java.lang.Object param)
    {
        ...
        java.lang.String xmlName=KOFHelper.getKeyByValue(classNames,obj);
        if(xmlName==null)
        {
            return obj;
        }
