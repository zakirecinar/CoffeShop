...
public class KOFKPSPublicSoap
{
    ...
    public KOFKPSPublicSoap(){}

    public KOFKPSPublicSoap(String url)
    {
        this.url = url;
    }

    public KOFKPSPublicSoap(String url,int timeOut)
    {
        this.url = url;
    ...
    {
        KOFExtendedSoapSerializationEnvelope envelope= new KOFExtendedSoapSerializationEnvelope(KOFExtendedSoapSerializationEnvelope.VER11);
